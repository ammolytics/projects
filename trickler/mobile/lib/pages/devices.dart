...
class _DevicesPageState extends State<DevicesPage> {
  ...
  void _scanDevices() {
    try {
      ...
      _scanSubscription = _flutterBlue.scan(timeout: const Duration(seconds: 20)).listen((scanResult) {
        print('\n>>> ${scanResult.advertisementData.localName}, ${scanResult.device.id}, ${scanResult.device.name}, RSSI: ${scanResult.rssi} <<<\n\n');
