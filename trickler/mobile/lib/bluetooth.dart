...
void subToBTState(AppState appState) {
  print('Listening to BluetoothState...');
  appState.btStateSub = FlutterBlue.instance.state.listen((s) {
    appState.btState = s;
    print('Updating BluetoothState to $s');
  });
}

void unsubToBTState(AppState appState) {
  appState.btStateSub?.cancel();
  appState.btStateSub = null;
  appState.btState = BluetoothState.unknown;
}
